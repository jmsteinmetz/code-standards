...
Referenced from The Roundarch Isobar Front End Code Standards & Guidelines 

## Summary:

This document contains guidelines for web applications built by W2O Digital. It is to be readily available to anyone who wishes to check or contribute to the iterative progress of our discipline's best practices.
...
We hope to encourage other developers to think about how to best standardize their approaches to development, to propose their own ideas for debate and for inclusion in this version of the document, and to adapt our standards for their own unique development practices. 
